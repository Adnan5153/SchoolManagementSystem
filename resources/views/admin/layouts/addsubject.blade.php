...
<div class="row mt-4">
    ...
    <!-- List of Subjects with Filtering (Larger width) -->
    <div class="col-md-8">
        <div class="card shadow">
...
<!-- AJAX Script to Filter Subjects -->
<script>
        ...
        fetch(`/admin/subjects/filter?class_id=${classId}`)
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    ...
                    tableBody.innerHTML = `<tr><td colspan="4" class="text-center">No subjects found</td></tr>`;
                }
            })
