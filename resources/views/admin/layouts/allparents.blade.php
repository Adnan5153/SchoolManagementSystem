            ...
            <tbody>
                ...
                <tr class="font">
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#editParentModal-{{ $parent->id }}">
                            <i class="fa-solid fa-pen-to-square" style="color: #FFD43B;"></i>
                        </a>

                        <!-- Delete form -->
                        <form action="{{ route('allparents.destroy', $parent->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm" onclick="return confirm('Are you sure you want to delete this parent?')">
